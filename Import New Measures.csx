var targetTable = Model.Tables["Key Measures"];  // Name of the table that should hold the measures
...
foreach(var row in tsvRows.Skip(1))
{
    ...
    var expression = tsvColumns[1];       // 3rd column contains measure expression
